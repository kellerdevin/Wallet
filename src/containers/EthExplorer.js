...
const API = 'https://ropsten.etherscan.io/tx/0xfe3848c051023e29cc62843e090e5a5b849ec6eb8ad98bfc8e28af2551116701'
        ...
        return (
            ...
            <View style={{ backgroundColor: 'white' }}>
                <View style={{ marginLeft: 20}}>
                    ...
                    <Text>Contract 0x16c31228f6413043ac0e41e9617394906c7a21ac{'\n'}</Text>
                    <Text style={[styles.bold]}>Token Transfer: </Text>
                    <Text> 2 ERC20 (Twoken Token)  from 0x00000000000000... to  0x9c3e099eb426e4{'\n'}</Text>
                    ...
                    <Text>/-ë@9Keepall 45 year: 2016, manufacturer: LV, date:6/21/2018</Text>
                </View>
            </View>
            </ScrollView>
        );
